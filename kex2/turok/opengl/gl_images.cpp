        ...
        case 8:
            {
                ...
                *output = data;
                ...
                case 32:
                    ...
                    break;
                default:
                    common.Error("%i-bit color map not supported for %s", tga.cmap_bits, name);
                    break;
                }
            }
            break;
        case 24:
            common.Error("24 bits (indexed) is not supported for %s", name);
        case 32:
            common.Error("32 bits (indexed) is not supported for %s", name);
            break;
        default:
            common.Error("unknown pixel bit for %s", name);
            break;
        }
        break;
    case TGA_TYPE_RGB:
        ...
        break;
    case TGA_TYPE_BW:
        common.Error("grayscale images is not supported for %s", name);
        break;
    case TGA_TYPE_RLE_INDEXED:
        common.Error("RLE indexed images is not supported for %s", name);
        break;
    case TGA_TYPE_RLE_RGB:
        common.Error("RLE images is not supported for %s", name);
        break;
    case TGA_TYPE_RLE_BW:
        common.Error("RLE grayscale images is not supported for %s", name);
        break;
    default:
        common.Error("%s has unknown tga type", name);
        break;
    }
