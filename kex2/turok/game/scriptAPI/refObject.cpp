...
//-----------------------------------------------------------------------------
//
// DESCRIPTION: Script Handle Object
...
void kexScriptObjHandle::Init(void) {
    scriptManager.Engine()->RegisterObjectType(
        "ref",
        sizeof(kexScriptObjHandle),
        asOBJ_VALUE | asOBJ_ASHANDLE | asOBJ_APP_CLASS_CDAK);

    scriptManager.Engine()->RegisterObjectBehaviour(
        "ref",
        asBEHAVE_CONSTRUCT,
        "void f()",
        asFUNCTIONPR(kexScriptObjHandle::ObjectConstruct,
        (kexScriptObjHandle*), void),
    ...
    scriptManager.Engine()->RegisterObjectBehaviour(
        ...
        "void f(const ref &in)",
        asFUNCTIONPR(kexScriptObjHandle::ObjectConstruct,
        (kexScriptObjHandle*, const kexScriptObjHandle&), void),
        asCALL_CDECL_OBJFIRST);
    ...
    scriptManager.Engine()->RegisterObjectBehaviour(
        ...
        "void f(const ?&in)",
        asFUNCTIONPR(kexScriptObjHandle::ObjectConstruct,
        (kexScriptObjHandle*, void*, int), void),
        asCALL_CDECL_OBJFIRST);
    ...
    scriptManager.Engine()->RegisterObjectBehaviour(
        ...
        asBEHAVE_DESTRUCT,
        "void f()",
        asFUNCTIONPR(kexScriptObjHandle::ObjectDeconstruct,
        (kexScriptObjHandle *), void),
        asCALL_CDECL_OBJFIRST);
    ...
    scriptManager.Engine()->RegisterObjectBehaviour(
        ...
        asBEHAVE_REF_CAST,
        "void f(?&out)",
        asMETHODPR(kexScriptObjHandle, Cast,
        (void**, int), void),
        asCALL_THISCALL);

    scriptManager.Engine()->RegisterObjectMethod(
        "ref",
        "ref &opAssign(const ref &in)",
        asMETHOD(kexScriptObjHandle,
        operator=),
        asCALL_THISCALL);

    scriptManager.Engine()->RegisterObjectMethod(
        "ref",
        "ref &opAssign(const ?&in)",
        asMETHOD(kexScriptObjHandle,
        Assign),
        asCALL_THISCALL);
    ...
    scriptManager.Engine()->RegisterObjectMethod(
        ...
        asMETHODPR(kexScriptObjHandle,
        operator==, (const kexScriptObjHandle &) const, bool),
        asCALL_THISCALL);

    scriptManager.Engine()->RegisterObjectMethod(
        "ref",
        "bool opEquals(const ?&in) const",
        asMETHODPR(kexScriptObjHandle, Equals,
        (void*, int) const, bool),
        asCALL_THISCALL);
}
